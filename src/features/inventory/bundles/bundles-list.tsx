...
import { Package, DollarSign, Percent, Tag, ShoppingBag, Coins, ChevronDown, ChevronUp, FileText } from "lucide-react"
  ...
  if (Object.keys(groupedBundles).length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-10">
        ...
        <h3 className="text-xl font-medium mb-2">No hay paquetes disponibles</h3>
        <p className="text-muted-foreground">Crea tu primer paquete usando la pestaña "Crear Nuevo Paquete".</p>
      </div>
    )
  }
            ...
            {bundles.map((bundle) => (
              <Card key={bundle.id} className="overflow-hidden flex flex-col">
                <CardHeader className="pb-2">
                  ...
                  {bundle.description && (
                    <p className="text-sm text-muted-foreground mt-1 whitespace-pre-line">{bundle.description}</p>
                  )}
                ...
                <CardContent className="py-2 flex-grow">
                  <div className="grid grid-cols-2 gap-2 text-sm mb-4">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-medium">{Number(bundle.discountPercentage).toFixed(1)}%</span>
                    </div>
                ...
                <CardFooter className="pt-2 pb-4">
                  ...
                  >
                    ...
                    <CollapsibleContent className="space-y-4 pt-4">
                      ...
                      {/* Verificamos si notes existe antes de intentar renderizarlo */}
                      {bundle.notes && (
                        <div className="border-t pt-4">
                          ...
                          <p className="text-sm text-muted-foreground whitespace-pre-line">{bundle.notes}</p>
                        </div>
                      )}
                          ...
                          {bundle.items.map((item) => (
                            <div key={item.itemId} className="flex justify-between items-center text-sm">
                              ...
                              <div className="text-right">
                                ...
                                {/* Verificamos si costPrice existe antes de usarlo */}
